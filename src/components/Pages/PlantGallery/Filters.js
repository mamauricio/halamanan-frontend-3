...
const categories = {
  ...
  hardscape: ['Lights', 'Fixtures', 'Stone', 'Pavers', 'Wood'],
};
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
            <FormControl sx={{ width: '300px' }}>
              ...
              >
                ...
                <MenuItem key="softscape" value="softscape">
                  Softscape
                </MenuItem>
                <MenuItem key="hardscape" value="hardscape">
                  Hardscape
                </MenuItem>
                <MenuItem key="favorites" value="favorites">
                  Favorites
                </MenuItem>
              </Select>
            </FormControl>
