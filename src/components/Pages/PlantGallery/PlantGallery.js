      ...
      >
        ...
        >
          ...
          >
            ...
            <CustomAlert showAlert={showAlert} closeAlert={closeAlert} />
            <Box
              sx={{
                float: 'right',
                display: 'flex',
          ...
          <Container maxWidth={'xl'}>
            ...
            >
              <Box className="object-display" display="flex" flexWrap="wrap">
                {filteredItems.length === 0 ? (
                  ...
                  <>
                    {filteredItems.map((item, index) => (
                      <Grow in={filteredItems != null} key={index}>
                        <div
                          key={index}
                          className={
                            index === activeItem
                          ...
                          >
                            ...
                            {index === activeItem ? (
                              <div className="conditional">
                                <div ref={childRef} className="itemInformation">
