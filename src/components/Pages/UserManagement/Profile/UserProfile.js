  ...
  const handleDelete = async (itemId) => {
    try {
      const response = await axios.delete(
        // `https://halamanan-197e9734b120.herokuapp.com/profile/pending/${itemId}`,
        `https://halamanan-197e9734b120.herokuapp.com/profile/pending`,
        {
          params: {
            id: itemId,
      ...
      const updated = pendingItems.filter(
        (pendingItem) => pendingItem.itemId !== itemId
      );
                      ...
                      <Grow in={showItems} key={index}>
                        ...
                        >
                          <Box sx={{ display: 'flex', justifyContent: 'end' }}>
                            ...
                            <Zoom in={openAlert} onClose={handleCloseAlert}>
                              <Alert
                          ...
                          <Box>
                            Item Category:{' '}
                            {item.newItemCategory && item.newItemCategory}
                          </Box>
                          <Box>
                            {item.newItemType && (
